...
/// A page extension for Jaspr Content that adds page navigation
/// to the current tutorial page.
  ...
  Future<List<Node>> apply(Page page, List<Node> nodes) async {
    ...
    page.apply(
      data: {
        'page': {
          if (nextChapter != null)
            'nextpage': {'title': nextChapter.title, 'url': nextChapter.url},
          if (prevChapter != null)
            'prevpage': {'title': prevChapter.title, 'url': prevChapter.url},
        },
      },
    );
